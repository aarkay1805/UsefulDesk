-- Cap automated absence contact at two provider attempts in one visit-free streak.
-- Keep contact-wide spacing and overnight scheduling from the prior migration.
...
BEGIN
  ...
  WITH config AS (
    ...
    ORDER BY account_id, contact_id, visit_on, streak_start, membership_id
