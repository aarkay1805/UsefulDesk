-- Keep the hourly collection/retention batch independent from a daily burst
-- of absent members. The dedicated 15-minute worker owns this kind.
...
GRANT EXECUTE ON FUNCTION public.claim_lifecycle_reminder_jobs(TEXT, INTEGER)
  TO service_role;
