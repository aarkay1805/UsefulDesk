...
const members = [
  {
    ...
    due: "Today",
    fee: "₹2,499",
    tint: "linear-gradient(145deg,#7c3aed,#4f46e5)",
  },
  {
    name: "Neha Kapoor",
    initials: "NK",
    ...
    due: "In 2 days",
    fee: "₹6,900",
    tint: "linear-gradient(145deg,#ec4899,#db2777)",
  },
  {
    name: "Rohan Shah",
    initials: "RS",
    ...
    due: "In 3 days",
    fee: "₹2,200",
    tint: "linear-gradient(145deg,#0ea5e9,#2563eb)",
  },
];
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 19, color: "#8f8b9c", marginTop: 6 }}>
                Next 7 days · 17 members
              </div>
            </div>
            <div
              style={{
            ...
            {members.map((member, index) => (
              <Interactive.Div
                ...
                style={{
                  ...
                  border:
                    index === 0
                      ? "1px solid rgba(139,92,246,0.46)"
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 17, color: "#8f8b9c", marginTop: 5 }}>
                    {member.plan}
                  </div>
                </div>
                ...
                <div
                  style={{
                    ...
                    color: "#ffffff",
                    backgroundColor:
                      index === 0 ? "#7c3aed" : "rgba(255,255,255,0.07)",
                  }}
                >
