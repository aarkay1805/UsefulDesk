    ...
    <div className="space-y-6">
          ...
          {loadingFields ? (
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_140px_minmax(0,1fr)]">
              ...
              <input
                ...
                placeholder="Value"
                className="border-border text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-primary h-9 rounded-lg border px-2.5 text-sm outline-none focus:ring-1"
              />
            </div>
          )}
        </div>
            ...
            {tags.map((tag) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium transition-all ${
                    isExcluded
                      ? 'text-red-foreground border-red-500/30 bg-red-500/10'
                      : 'border-border bg-muted text-muted-foreground hover:border-border'
                  }`}
                >
                  {tag.name}
      ...
      <div className="border-border bg-card/50 rounded-xl border p-4">
        ...
        {loadingCount ? (
          ...
          <div className="flex items-center gap-2">
            <Users className="text-primary-text h-4 w-4" />
