    ...
    <div className="border-border bg-card flex h-[60vh] min-h-[420px] flex-col rounded-xl border">
      ...
      <div className="border-border flex items-center justify-between border-b px-4 py-3">
        <div className="flex items-center gap-2">
          <Bot className="text-primary-text h-4 w-4" />
      ...
      <div ref={scrollRef} className="flex-1 space-y-4 overflow-y-auto p-4">
        ...
        {turns.map((t, i) => (
          ...
          >
            {t.role === 'assistant' && (
              <Bot className="text-primary-text mt-1 h-5 w-5 shrink-0" />
            )}
            <div
              className={cn(
            ...
            >
              ...
              {t.role === 'assistant' && t.handoff && (
                <p
                  className={cn(
                    'text-amber-foreground flex items-center gap-1 text-xs',
        ...
        {sending && (
          <div className="text-muted-foreground flex items-center gap-2 text-sm">
            <Bot className="text-primary-text h-5 w-5" />
