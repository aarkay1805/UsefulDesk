...
/** Browser paint cache. The authenticated profile is authoritative. */
 ...
 *
 * Cached under its own localStorage key so it composes freely with the
 * accent choice (you can run Violet-light or Violet-dark). The signed-in
 * user's profile is the cross-browser source of truth.
 */
