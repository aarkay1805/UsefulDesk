...
export const MEMBER_TEMPLATE_CSV = [
  'Name,Phone,Email,Plan,Billing option,Start date,Expiry,Status,Service,Service option,Service trainer,Service start date,Service expiry,Service sold price,Service status,Fee,Amount paid,Payment method,Payment date,Assigned to,May leave,Birthday,Gender,Height,Weight,City,State,Postal code,Notes,Tags',
