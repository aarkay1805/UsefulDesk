...
//
// Authenticated. Caller atomically adds the invited branch membership
// without removing any existing branch access.
//
...
//   - SQLSTATE 23505 → 409 (already a member of this branch)
//
...
function rpcErrorToResponse(err: PostgrestError): NextResponse {
  ...
  return NextResponse.json(
    { error: 'Could not redeem invitation' },
    { status: 500 }
  );
}
