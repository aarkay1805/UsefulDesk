...
**Still open:** selecting and separately authorizing any real gym-owner pilot; broader co-branded rollout; richer `payment.failed` handling; owner approval of the exact `gym_payment_link` language/body followed by Meta submission and approval before WhatsApp Send (the authenticated 2026-08-12 Production sync returned zero provider templates); UsefulDesk-initiated partial refunds; and WhatsApp Send.
