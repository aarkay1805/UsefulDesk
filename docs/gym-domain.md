...
**Still open:** selecting and separately authorizing any real gym-owner pilot; broader co-branded rollout; richer `payment.failed` handling; approval of `gym_payment_link` before WhatsApp Send; UsefulDesk-initiated partial refunds; and WhatsApp Send.
